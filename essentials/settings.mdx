...
description: 'Configure the look and feel of your documentation using the docs.json file'
icon: 'gear'
---

Every documentation site needs a `docs.json` file with the core configuration settings. Learn more about the [properties](#properties) below.
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://fortt.sh/docs`
    </ResponseField>
